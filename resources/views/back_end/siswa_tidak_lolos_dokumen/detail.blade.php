        ...
        <div class="card-body">
            <div class="col-12">
                  ...
                  <div class="col-md-8">
                    <div class="row">
                      ...
                      <div class="col">
                        ...
                        <a href="{{ route('siswa-tidak-lolos-dokumen') }}" data-toggle="tooltip" data-original-title="detail" class="btn btn-xs btn-secondary float-right me-1">
                          Kembali
                        </a>
                ...
                <div class="row mt-4">
                  ...
                  <div class="col">
                    <a href="{{ route('siswa-tidak-lolos-dokumen') }}" data-toggle="tooltip" data-original-title="detail" class="btn btn-sm btn-secondary float-right me-1">
                      Kembali
                    </a>
                  </div>
